  ...
  render() {
    ...
    const renderActionBar = () => {
      return <div className={style.action_bar_box}>
        <Button className={style.action_bar_btn} type="primary" size="small" onClick={this.newBuildTaskModalVisible} icon={<PlusOutlined />}>新建构建任务</Button>
        <Button className={style.action_bar_btn} type="primary" size="small" onClick={this.uploadModalVisible} icon={<PlusOutlined />}>导出镜像</Button>
        <Button className={style.action_bar_btn} type="primary" size="small" onClick={this.uploadModalVisible} icon={<PlusOutlined />}>删除镜像</Button>
      </div>
    }
